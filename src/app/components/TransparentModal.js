    ...
    function TransparentModal({ isOpen, onClose, itemName, itemLink, servingSize, numServings, caloriesPS, FatPS, CarbPS, ProteinPS, Recipe, directions }) {
                ...
                <Dialog as="div" className="relative z-50" onClose={onClose}>
                    ...
                    <Dialog.Panel className="relative flex items-center transform overflow-hidden rounded-lg transition-all md:mt-0 mt-0 mb-0 sm:w-full">
                        ...
                        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto bg-gray-200 mt-16 rounded-lg">
                                ...
                                {Recipe && (
                                        <div className="mt-4 w-full px-4 py-2 bg-white max-w-5xl text-left rounded-lg shadow">
                                            <h3 className="text-lg font-semibold">Cooking Directions:</h3>
                                            <ol className="list-decimal list-inside">
                                                {Object.keys(directions).map((key) => (
                                                    <li key={key} className="mt-1">{directions[key]}</li>
                                                ))}
                                            </ol>
                                        </div>
                                    )}
